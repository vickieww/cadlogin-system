    ...
    <div class="edit-container">
        ...
        <form method="post" action="index.php?action=edit&id=<?= $user['id']?>" class="edit-form">
            ...
            <select name="perfil" id="perfil">
                ...
                <!-- Utiliza ? para fazer confirmação do usuário logado no sistema e, ao clicar no botão de edição, redireciona-o para editar e informa o perfil atual no sistema -->
            </select>
