...
<option value="colaborador"<?= $user['perfil'] == 'colaborador' ? 'selected' : '' ?>>Colaborador</option><!-- Utiliza ? para fazer confirmação do usuário logado no sistema e, ao clicar no botão de edição, redireciona-o para editar e informa o perfil atual no sistema -->
</select>
